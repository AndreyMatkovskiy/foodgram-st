...
# База данных для запуска через docker-compose
# DATABASES = {
#     'default': {
...
# База данных для локального запуска (проверка postman collection)
DATABASES = {
    'default': {
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        'user_create': 'api.serializers.users_serializers.UserCreateSerializer',
    },
    'PERMISSIONS': {
